<!-- end #footer-top -->
                ...
                <div class="row">
                    ...
                    <div class="span3" id="footer-widget-area-4">                        
                        ...
                        <div class="widget ewf_widget_newsletter">                            
                            <form id="newsletter-subscribe-form" action="index.php">
			...
			<div class="container">
                <div class="row">                
                    ...
                    <div class="span6" id="footer-bottom-widget-area-1">                        
                        <div class="widget widget_text">                        
                            <div class="textwidget">
                                <p class="text-uppercase text-right"><strong>Powered By Leadefine</strong></p>
                            </div><!-- end .textwidget -->                            
                        </div><!-- end .widget_text -->                        
                    </div>
                </div><!-- end .row -->
    ...
    <a id="back-to-top" href="index.php">
    	<i class="ifc-up4"></i>
    </a>
