...
var ck_layout = cookie( 'elevator-layout' ),
	ck_skin   = cookie( 'elevator-skin' ),
	ck_bg     = cookie( 'elevator-bg' );
if( ck_layout ){
	var ck_layout = ck_layout == "boxed" ? "boxed" : "wide";
	layout      = document.getElementById('elevator-layout');
	layout.href = "assets/css/" + ck_layout + ".css";
	cookie( 'elevator-layout', ck_layout );
}
if( ck_skin ){
	switch( ck_skin ){
		case "red":
	...
	skin      = document.getElementById('elevator-skin');
	skin.href = "assets/css/skins/" + ck_skin + ".css";
	cookie( 'elevator-skin', ck_skin );
}
if( ck_bg ){
