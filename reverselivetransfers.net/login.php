...
{
	$_SESSION['pageURL']='';
	if(isset($_SESSION['sessAgentID']))
	{
		
		$_SESSION['sessAgentID']='';
		unset($_SESSION['sessAgentID']);
		
		$_SESSION['agent_userUser']='';
		unset($_SESSION['agent_userUser']);
		
		$_SESSION['agent_center']='';
		unset($_SESSION['agent_center']);
...
if(isset($_POST['submit'])){
	...
	else 
	{
		...
		$field=null;
		$where=array('ag_username'=>$_POST['strUserid'], 'password'=>$pw);
		
		 $looginSQLresult=$sqli->get_selectData("SELECT * FROM agent_user where ag_username = '".$_POST['strUserid']."' AND ag_password = '".$pw."' AND ag_status = 1");
		 	
			if(count($looginSQLresult) >0)
			{
			$_SESSION['sessAgentID'] = $looginSQLresult[0]['agid'];
			$_SESSION['agent_userUser']=$looginSQLresult[0]['ag_username'];
			$_SESSION['agent_center']=$looginSQLresult[0]['ag_center'];
...
<div id="main_container">
  ...
  <tr>
    ...
    <div class="footer_login">
    	...
    	<div class="left_footer">&copy; <?php echo $footer; ?></div>
