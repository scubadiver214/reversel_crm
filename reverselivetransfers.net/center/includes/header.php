...
<div id="main_container">
    ...
    <div class="right_header">Welcome :&nbsp;<?php $sqli->table='center_user'; 
	$field=null; $where=array('cenid'=>$_SESSION['sessCenterID']); 
	$cenDet=$sqli->Get_data($field,$where);echo $cenDet[0][4]." ".$cenDet[0][5];
