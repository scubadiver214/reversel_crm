...
if(isset($_REQUEST['Go']))
    ...
    $statsqry = "SELECT d.dispid,count(f.`Reference`) stats FROM `freshleads` f,disposition d WHERE f.`Status` = d.dispid AND f.Cent_id=".$_SESSION['sessCenterID']." ".$strcond." ".$strconddefault."  GROUP By d.dispid";
    ...
    $statsqry1 = "SELECT d.dispid,count(f.`Reference`) stats, f.TransferDateTime FROM `freshleads` f,disposition d WHERE f.`Status` = d.dispid AND f.Cent_id=".$_SESSION['sessCenterID']." ".$strconddefault1." GROUP By d.dispid";
    ...
    $statsqry2 = "SELECT d.dispid,count(f.`Reference`) stats, f.TransferDateTime FROM `freshleads` f,disposition d WHERE f.`Status` = d.dispid AND f.Cent_id=".$_SESSION['sessCenterID']." ".$strconddefault2." GROUP By d.dispid";
...
<div class="center_content">
             <div class="right_content"><h2>Affiliate Center Manager Dashboard</h2>
