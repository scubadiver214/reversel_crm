...
if(isset($_REQUEST['Search']))
	{
		...
		else
		{
			...
			{
				$strcond.=" AND freshleads.FirstName LIKE '%".$_REQUEST['str_firstName']."%' AND  Buyer = '". $_SESSION['sessClientID']."'";
			}
			if($_REQUEST['str_phone']!="")
			{
					$strcond.=" AND freshleads.Telephone1 = '".$_REQUEST['str_phone']. "' AND  Buyer = '". $_SESSION['sessClientID']."'";
			}
			
			if($_REQUEST['dd_client']!="")
			{
					$strcond.=" AND freshleads.Buyer = '".$_REQUEST['dd_client']. "' AND  Buyer = '". $_SESSION['sessClientID']."'";
			}
			if($_REQUEST['dd_status']!="")
			{
					$strcond.=" AND freshleads.Status = '".$_REQUEST['dd_status']. "' AND  Buyer = '". $_SESSION['sessClientID']."'";
			}
			if($_REQUEST['dd_camp']!="")
			{
					$strcond.=" AND freshleads.campaignid = '".$_REQUEST['dd_camp']. "' AND  Buyer = '". $_SESSION['sessClientID']."'";
			}
			if($_REQUEST['dd_center']!="")
			{
					$strcond.=" AND freshleads.Cent_id = '".$_REQUEST['dd_center']. "' AND  Buyer = '". $_SESSION['sessClientID']."'";
			}
			if($_REQUEST['dd_stateName']!="")
			{
					$strcond.=" AND freshleads.stateName LIKE '%".$_REQUEST['dd_stateName']."%' AND  Buyer = '". $_SESSION['sessClientID']."'";
			}
    ...
    <tr>
     ...
     <select name="dd_status" id="dd_status">
       <option value="">- Select -</option>
        <?php
		$strQuery5="select * from disposition where dispid>1";
