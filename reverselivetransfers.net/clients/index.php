...
if(isset($_REQUEST['Go']))
    ...
    $statsqry = "SELECT d.dispid,count(f.`Reference`) stats, f.TransferDateTime FROM `freshleads` f,disposition d WHERE f.`Status` = d.dispid AND f.Buyer=".$_SESSION['sessClientID']." ".$strcond." ".$strconddefault."   GROUP By d.dispid";
    ...
    $statsqry1 = "SELECT d.dispid,count(f.`Reference`) stats, f.TransferDateTime FROM `freshleads` f,disposition d WHERE f.`Status` = d.dispid AND f.Buyer=".$_SESSION['sessClientID']." ".$strconddefault1." GROUP By d.dispid";
    ...
    $statsqry2 = "SELECT d.dispid,count(f.`Reference`) stats, f.TransferDateTime FROM `freshleads` f,disposition d WHERE f.`Status` = d.dispid AND f.Buyer=".$_SESSION['sessClientID']." ".$strconddefault2." GROUP By d.dispid";
