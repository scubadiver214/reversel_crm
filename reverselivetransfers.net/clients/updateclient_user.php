...
if(isset($_POST['submit']))
{
			...
			if(isset($_POST['str_receive_email']))$updateInformation['receive_email']	=$_POST['str_receive_email'];
            else $updateInformation['receive_email']	=0;
 ...
 <div class="main_content">
  ...
  <tr>
    <td><table border="0" align="center" cellpadding="2" cellspacing="3" width="100%">
      ...
      <tr>
        <td width="16%" align="right" nowrap="nowrap">First Name <span class="err">*</span>:</td>
        <td width="25%"><input type="text" class="required textbox" name="str_clt_fname" id="str_clt_fname" size="30" value= "<?php echo $data[0]['clt_fname']; ?>"/></td>
        <td width="14%" align="right" nowrap="nowrap">Last Name <span class="err">*</span>:</td>
        <td width="45%"><input type="text" class="required textbox" name="str_clt_lname" id="str_clt_lname" size="30"  value= "<?php echo $data[0]['clt_lname'] ; ?>"/></td>
        </tr>
      <tr>
        <td width="16%" align="right" nowrap="nowrap">Company<span class="err">*</span> :</td>
        <td width="25%"><input type="text" class="required textbox" name="str_clt_comp" id="str_clt_comp" size="30" value= "<?php echo $data[0]['clt_comp']; ?>" /></td>
        <td width="14%" align="right" nowrap="nowrap">Cell  Phone Number<span class="err">*</span>:</td>
        <td width="45%"><input type="text" class="required textbox" name="str_clt_mobile" id="str_clt_mobile" size="30" value= "<?php echo $data[0]['clt_mobile']; ?>" /></td>
        </tr>
      <tr>
        <td width="16%" align="right" nowrap="nowrap">City :</td>
        <td width="25%"><input type="text" class="required textbox" name="str_clt_city" id="str_clt_city" size="30"  value= "<?php echo $data[0]['clt_city']; ?>"/></td>
        <td width="14%" align="right" nowrap="nowrap">Alias Name<span class="err">*</span>:</td>
        <td width="45%"><input type="text" class="required textbox" name="str_clt_alias" id="str_clt_alias" size="30" value= "<?php echo $data[0]['clt_alias']; ?>"/></td>
        </tr>
      <tr>
        <td width="16%" align="right" nowrap="nowrap">State :</td>
        <td width="25%">
...
$datastate=$sqli->get_selectData($strQuery14); 
	 ...
	 foreach($datastate as $key=>$valuestate){?>
        ...
        <td width="14%" align="right" nowrap="nowrap">Country :</td>
        <td width="45%"><input type="text" class="required textbox" name="str_clt_country" id="str_clt_country" size="30" value= "<?php echo $data[0]['clt_country']; ?>"/></td>
        </tr>
      <tr>
        <td width="16%" align="right" nowrap="nowrap">Zipcode :</td>
        <td width="25%"><input type="text" class="required textbox" name="str_clt_zipcode" id="str_clt_zipcode" size="30" value= "<?php echo $data[0]['clt_zipcode'] ?>" /></td>
        <td width="14%" rowspan="3" align="right" valign="top" nowrap="nowrap">Company Address:</td>
        <td width="45%" rowspan="3"><textarea name="str_clt_comp_address" cols="32" rows="5" class="" id="str_clt_comp_address"><?php echo $data[0]['clt_comp_address']; ?></textarea></td>
        </tr>
      <tr>
        <td width="16%" align="right" nowrap="nowrap">Phone :</td>
        <td width="25%"><input type="text" class="required textbox" name="str_clt_phone" id="str_clt_phone" size="30"  value= "<?php echo $data[0]['clt_phone']; ?>"/></td>
        </tr>
      <tr>
        <td width="16%" align="right" valign="top" nowrap="nowrap">Fax :</td>
        <td width="25%"><input type="text" class="required textbox" name="str_clt_fax" id="str_clt_fax" size="30" value= "<?php echo $data[0]['clt_fax']; ?>"/></td>
        </tr>
        

           <tr>
        <td width="16%" align="right" nowrap="nowrap">Skype ID:</td>
        <td width="25%"><input type="text" class="required textbox" name="str_clt_skype" id="str_clt_skype" size="30" value= "<?php echo $data[0]['clt_skype']; ?>" /></td>
        <td width="14%" align="right" nowrap="nowrap">Phone Transfer Line:</td>
        <td width="45%"><input type="text" class="required textbox" name="str_clt_ph_transfer" id="str_clt_ph_transfer" size="30" value= "<?php echo $data[0]['clt_ph_transfer']; ?>" /></td>
        </tr>
      ...
      <tr>
        <td width="16%" align="right" nowrap="nowrap">Time Zone :</td>
        <td width="25%">
        ...
        <td width="14%" align="right" nowrap="nowrap">Other ID</td>
        <td width="45%"><input type="text" class="required textbox" name="str_clt_other_id" id="str_clt_other_id" size="30" value= "<?php echo $data[0]['clt_other_id']; ?>"/></td>
       </tr>
        
      <tr>
       
        <td width="16%" align="right" nowrap="nowrap">Company Detail</td>
        <td width="25%" rowspan="2"><textarea name="str_clt_detail" id="str_clt_detail" cols="32" rows="5"><?php echo$data[0]['clt_detail'] ; ?>
     </textarea></td>
     
      <td width="14%" align="right" valign="top" nowrap="nowrap">Receive Email :</td>
        <td width="45%" valign="top"><input name="str_receive_email" type="checkbox" id="str_receive_email" value="1" <?php if($data[0]['receive_email']== '1') echo "checked"; ?> /></td>
        </tr>
      <tr>
        <td width="16%" align="right" valign="top" nowrap="nowrap">&nbsp;</td>
        <td width="14%">&nbsp;</td>
