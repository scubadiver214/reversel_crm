...
$strQueryAgent ="Select * from agent_user where agid='".$_SESSION['sessAgentID']."'";
$dataAgent=$sqli->get_selectData($strQueryAgent);
 
$strQueryPer ="Select * from tbl_center_permission where cent_id='".$dataAgent[0]['ag_center']."' AND all_trn_ph=1";
...
<div class="menu">
  ...
  <tr>
   ...
   <!--  <a href="lead_order.php"><img src="images/add-details.png" alt="" title="Add New Order" border="0" /></a>-->
    ...
    <thead>
    	<tr>
        	<th width="40" nowrap="nowrap" class="rounded-company" scope="col"></th>
        
            <th align="left" nowrap="nowrap" class="rounded" scope="col"><strong>Order Id</strong></th>
			...
			<th align="left" nowrap="nowrap" class="rounded" scope="col"><strong>Transferred</strong></th>
