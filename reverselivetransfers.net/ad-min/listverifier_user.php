<?php 
$pagename = "listverifier_user.php";
...
if(isset($_POST['Search']))
{
	...
	if($_POST['str_id'] !="")
	{
		$strcond.=" AND verifier_user.verifier_id = '".$_POST['str_id']. "' ";
		
	}
	if($_POST['str_UserName'] !="")
	{
		$strcond.=" AND verifier_user.verifier_username LIKE '%".$_POST['str_UserName']."%'";
	}
	if($_POST['str_firstName'] !="")
	{
		$strcond.=" AND verifier_user.verifier_fname LIKE '%".$_POST['str_firstName']."%'";
	}
	if($_POST['str_lastName'] !="")
	{
		$strcond.=" AND verifier_user.verifier_lname LIKE '%".$_POST['str_lastName']."%'";
		
	}
	if($_POST['str_email'] !="")
	{
		$strcond.=" AND verifier_user.verifier_email = '".$_POST['str_email']. "' ";
	}
	if($_POST['str_mobile'] !="")
	{
		$strcond.=" AND verifier_user.verifier_mobile = '".$_POST['str_mobile']. "' ";
...
$strQuery = "Select * from verifier_user where 1".$strcond."";
$items_per_page=5;
...
<div class="menu">
  ...
  <tr>
    <td><h2>Verifiers  List</h2></td>
    <td align="right"><a href="verifier_user.php"><img src="images/add-details.png" alt="" title="Add New Verifier" border="0" /></a></td>
  </tr>
</table>
...
<!-- search form -->
    ...
    <tr>
     ...
     <tr>
       ...
       <td width="40%" align="left" valign="top">&nbsp;</td>
         ...
         <table id="rounded-corner" summary="List of verifier_user" width="100%">
    <thead>
    	<tr>
    ...
    <tbody>
         ...
         <td ><?php echo ($pagen*$items_per_page+$i);$i++; ?></td>
               <td ><?php echo $row['verifier_username']; ?></td>               
                             
            <td ><?php echo $row['verifier_fname']." ".$row['verifier_lname']; ?></td>
             <td><?php echo $row['verifier_mobile']; ?></td>
               <td><?php echo $row['verifier_email']; ?></td>
               <td style="padding-left: 1%;"><a href="updateverifier_user.php?vfID=<?PHP echo $row['verifier_id']; ?>"><img src="images/user_edit.png" alt="" title="Edit" border="0" /></a></td>
          <td style="padding-left: 4%;"><a href="updateverifier_pwd.php?vfID=<?PHP echo $row['verifier_id']; ?>"><img src="images/user_edit.png" alt="" title="Edit Password" border="0" /></a></td>
         
           <td>
               <?php  if ($row['verifier_status'] == 1)  { ?> 
				<a href="?updid=<?php echo $row['verifier_id']; ?>&stat=0&action=StatusChange&key=<?php echo md5(date("ymdhis")) ?>"> <img src="images/green.png" alt="" title="Change Status" border="0" />  </a>
                 <?php  } else { ?> 
				<a href="?updid=<?php echo $row['verifier_id']; ?>&stat=1&action=StatusChange&key=<?php echo md5(date("ymdhis")) ?>">  <img src="images/red.png" alt="" title="Change Status" border="0" />  </a>
                 <?php } ?>               
               </td>
                <td align="center"><a href="listverifier_user.php?del_ID=<?PHP echo $row['verifier_id']; ?>"><img src="images/user_logout.png" alt="" title="Delete" border="0" onclick="return confirm('Confirm to delete verifier!')"/></a></td>
        </tr>    
         <?php }  ?>
    </tbody>
      <tfoot>
