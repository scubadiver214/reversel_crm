...
JQ(document).ready(function() {
  ...
  <tr>
    ...
    <fieldset>
   	 <legend>Order</legend>
    <table border="0" align="center" cellpadding="2" cellspacing="3" width="100%">
	<input type="hidden" name="str_clt_id" value="<?php echo $_GET['clientID']; ?>" />
    <tr>
   ...
   <td width="20%" align="left" valign="top"><select name="dd_Camp" id="dd_Camp">
     ...
     <?php
	$strQuery2="select * from campaigns where campaigns.cmp_id NOT IN ( select cmp_id from leadorder where clt_id='".$_GET['clientID']."')  AND status=1";
