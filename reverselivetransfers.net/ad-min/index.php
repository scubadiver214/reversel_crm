...
if(isset($_REQUEST['Go']))
    ...
    $statsqry = "SELECT d.dispid,count(f.`Reference`) stats FROM `freshleads` f,disposition d WHERE f.`Status` = d.dispid ".$strcond." ".$strconddefault." GROUP By d.dispid";
    ...
    $statsqry1 = "SELECT d.dispid,count(f.`Reference`) stats, f.TransferDateTime FROM `freshleads` f,disposition d WHERE f.`Status` = d.dispid ".$strconddefault1." GROUP By d.dispid";
    ...
    $statsqry2 = "SELECT d.dispid,count(f.`Reference`) stats, f.TransferDateTime FROM `freshleads` f,disposition d WHERE f.`Status` = d.dispid ".$strconddefault2." GROUP By d.dispid";
...
<form action="" method="post"><table width="100%" height="" border="0" cellspacing="0" cellpadding="0" style="width: 90%; padding-left: 8%;">
  <tr>
    ...
    <td>to</td>
    <td><input type="text" class="textbox" name="strlast_edit_date_to" size="30" id="strlast_edit_date_to" maxlength="30"  value="<?php echo $_REQUEST['strlast_edit_date_to']; ?>"/>&nbsp;&nbsp;<input name="Go" id="Go" type="submit" value="Go" /></td>
  </tr>
</table></form>
<br><br>
