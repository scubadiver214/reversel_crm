...
class TCPDFBarcode {
	 ...
	 * @param string $code code to print, separate the ZIP (routing code) from the rest using a minus char '-' (BarcodeID_ServiceTyiDel _MailerID_SerialNumber-RoutingCode)
	 * @return array barcode representation.
	 * @access protected
	 */
