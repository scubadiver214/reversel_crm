...
if(isset($_POST['submit']))
{
			...
			$updateInformation['verifier_pwd']	        = md5(trim($_POST['str_vf_pwd']));			
...
JQ(document).ready(function() {
 ...
 <div class="main_content">
  ...
  <tr>
    <td>  <h2> Update Verifier Password</h2></td>
  ...
  <tr>
    <td><table border="0" align="center" cellpadding="2" cellspacing="3" width="100%">
      ...
      <tr>
        ...
        <td width="40%"><input type="password" class="required textbox" id="str_vf_pwd" name="str_vf_pwd" size="20" /></td>
        </tr>
      <tr>
