...
<div id="main_container">
    ...
    <div class="right_header">Welcome :&nbsp;<?php $sqli->table='admin'; 
	$field=null; $where=array('adminid'=>$_SESSION['sessAdminID']); 
	$adminDet=$sqli->Get_data($field,$where);echo $adminDet[0][4]." ".$adminDet[0][5];
