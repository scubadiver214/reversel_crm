...
$statuscodes		=		$sqli->get_selectData("SELECT * FROM `disposition`");
...
<?php  foreach($_SESSION['message'] as $msg){ ?>
  ...
  <tr>
    ...
    <td><input type="hidden" name="ref" value="<?php echo $_REQUEST['ref']; ?>" /><?php  ?><?php echo $_REQUEST['ref']; ?></td>
  </tr>
  <tr>
    <td>Current Status</td> <td>:</td>
    <td><?php echo $orderDetails[0]['dispname']; ?></td>
  </tr>
  <tr>
    <td>New Status</td> <td>:</td>
  ...
  <tr>
    <td><input name="Change" type="submit" value="Change" /></td>
    <td>&nbsp;</td>
  </tr>
    </table></form>
</td>
