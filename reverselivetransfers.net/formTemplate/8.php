...
<option value="<?php echo $valuecr['credit_name'];?>" <?php if($data[0]['Data2']==$valuecr['credit_name']){echo "selected=\"selected\"";} ?>><?php echo $valuecr['credit_name'];?></option>
<?php }?>
    ...
    <tr>
      ...
      <td width="30%" align="left" nowrap="nowrap"> <select name="str_Data3" id="str_Data3">
         <option value="" selected="selected">Select..</option>
         <option value="SFR" <?php if($data[0]['Data3']== "SFR") echo "selected=\"selected\"" ?>>SFR</option>
         <option value="FHA approved Condo" <?php if($data[0]['Data3']== "FHA approved Condo") echo "selected=\"selected\"" ?>> FHA approved Condo</option>
          <option value="Manufactured Home" <?php if($data[0]['Data3']== "Manufactured Home") echo "selected=\"selected\"" ?>>Manufactured Home</option>
      ...
      <td width="30%" align="left">
       <select name="str_Data4" id="str_Data4">
         <option value="" selected="selected">Select..</option>
         <option value="Yes" <?php if($data[0]['Data4']== "Yes") echo "selected=\"selected\"" ?>>Yes</option>
         <option value="No" <?php if($data[0]['Data4']== "No") echo "selected=\"selected\"" ?>>No</option>
       </select>
        </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <input type="text" class="required textbox" name="str_Data8" size="30" id="str_Data8" value="<?php echo $data[0]['Data8']?>"/>
    </td>
 ...
 foreach($cr as $key=>$valuecr){?>
<option value="<?php echo $valuecr['credit_name'];?>" <?php if($data[0]['Data12']==$valuecr['credit_name']){echo "selected=\"selected\"";} ?>><?php echo $valuecr['credit_name'];?></option>
<?php }?>
      ...
      <tr>
       ...
       <td width="30%" align="left" nowrap="nowrap">
        <input type="text" class="required textbox" name="str_Data13" size="30" id="str_Data13" value="<?php echo $data[0]['Data13']?>"/>
       ...
       <select name="str_Data14" id="str_Data14">
         <option value="" selected="selected">Select..</option>
         <option value="Eliminate monthly mortgage" <?php if($data[0]['Data14']== "Eliminate monthly mortgage") echo "selected=\"selected\"" ?>>Eliminate monthly mortgage</option>
         <option value="Pay credit card bills" <?php if($data[0]['Data14']== "Pay credit card bills") echo "selected=\"selected\"" ?>>Pay credit card bills</option>
         <option value="More money every month" <?php if($data[0]['Data14']== "More money every month") echo "selected=\"selected\"" ?>>More money every month</option>
