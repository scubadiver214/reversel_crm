...
<div id="main_container">
    ...
    <div class="right_header">Welcome :&nbsp;<?php $sqli->table='verifier_user'; 
	$field=null; $where=array('verifier_id'=>$_SESSION['sessVerifierID']); 
	$cltDet=$sqli->Get_data($field,$where);echo $cltDet[0][4]." ".$cltDet[0][5];
