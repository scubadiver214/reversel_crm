...
$statuscodes		=		$sqli->get_selectData("SELECT * FROM disposition where dispid >=2 and dispid!=4 order by dispid ASC");
...
<?php  foreach($_SESSION['message'] as $msg){ ?>
  ...
  <tr>
    <td colspan="3" align="center"><h2 style="text-align: center;">Change Status</h2></td>
    </tr>
  <tr>
    <td style="padding-left: 10px;">Order Id</td> <td style="width: 3px;">:</td>
  ...
  <tr>
    <td><h2 style="text-align: center;"> Status History</h2></td>
  </tr>
  <tr>
