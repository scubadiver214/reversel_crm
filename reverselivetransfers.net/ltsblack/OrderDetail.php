...
.err{color:#F00; font-size:14px;}
 ...
 <div id="order_detail"> </div>
  ...
  <tr>
	...
	<td><input type="text"  class="required textbox" id="strFirstName" name="strFirstName" size="30" maxlength="30" disabled="disabled" value="<?php echo $orderDetails[0]['firstname'];?>" /></td></tr>
	<tr><td>Last Name <span class="err">*</span>:</td>
    
	<td><input type="text"  class="required textbox" name="strLastName" id="strLastName" size="30" maxlength="30" disabled="disabled"  value="<?php echo $orderDetails[0]['lastname'];?>" /></td>
  </tr>
  <tr>
    <td>Company</td>
    <td><input type="text"  class="required textbox" name="strCompany" id="strCompany" size="30" maxlength="30" disabled="disabled"  value="<?php echo $orderDetails[0]['shipping_company'];?>" /></td>
    </tr>
	<tr>
	  <td>Email id</td>
      <td><input type="text"  class="required textbox" name="strEmailId" id="strEmailId" size="30" maxlength="30" disabled="disabled"  value="<?php echo $orderDetails[0]['email'];?>"/></td>
	  </tr>
	<tr>
	  <td>Telephone  <span class="err">*</span>:</td>
	  <td><input type="text" class="required textbox" name="strTelephone" id="strTelephone" size="30" maxlength="30" disabled="disabled"  value="<?php echo $orderDetails[0]['telephone'];?>"/>
      </td>
	  </tr>
	<tr>
	  <td>Fax :</td>
	  <td><input type="text" class="required textbox" name="strFax" id="strFax" size="30" maxlength="30" disabled="disabled"  value="<?php echo $orderDetails[0]['fax'];?>" /></td>
	  </tr>
    </table>
    </td>
    <td width="40%" valign="top">
    ...
    <td>
    <input type="text"  class="required textbox" name="stradd1" id="stradd1" size="30" maxlength="30" disabled="disabled"  value="<?php echo $orderDetails[0]['shipping_address_1'];?>"/></td></tr>
    <tr>
    <td>Address 2</td>
    <td>
    <input type="text"  class="required textbox" name="strAdd2" id="strAdd2" size="30" maxlength="30" disabled="disabled"  value="<?php echo $orderDetails[0]['shipping_address_2'];?>" /></td></tr>
    <tr>
    <td>City</td>
    <td>
    <input type="text"  class="required textbox" name="strCity" id="strCity" size="30" maxlength="30" disabled="disabled"  value="<?php echo $orderDetails[0]['shipping_city'];?>"/></td></tr>
    <tr>
    <td>Postal Code <span class="err">*</span> :</td>
    <td>
    <input type="text"  class="required textbox" name="strPIN" id="strPIN" size="30" maxlength="30" disabled="disabled"  value="<?php echo $orderDetails[0]['shipping_postcode'];?>"/></td></tr>
   	<tr>
  ...
  <tr>
    ...
    <td><input type="text"  disabled="disabled" class="required textbox" name="strHeight" id="strHeight"   size="30" maxlength="30" value="<?php echo $orderDetails[0]['PatientHeight'];?>" /></td></tr>
     <tr><td>Patient DOB (mm/dd/yyyy)</td>
     <td><input type="text"  disabled="disabled" class="required textbox" name="strPatientDOB"   id="strPatientDOB" size="30" maxlength="30" value="<?php echo $orderDetails[0]['PatientDOB'];?>" /></td></tr>
  <tr><td>Patient Weight (lbs)</td>
   <td><input type="text"  disabled="disabled" class="required textbox" name="strWeight" id="strWeight"   size="30" maxlength="30" value="<?php echo $orderDetails[0]['PatientWeight'];?>" />
   </td></tr>
      <tr>
          <td>Reason for Ordering</td>
      <td>
      <input type="text"  disabled="disabled" class="required textbox" name="strReason" id="strReason"   size="30" maxlength="30" value="<?php echo $orderDetails[0]['ReasonforOrdering'];?>" />
      </td>
      </tr>
      <tr>
          <td>Prescribed Before</td>
<td><input type="text" class="required textbox" name="strPresBefore" id="strPresBefore" disabled="disabled"  size="30" maxlength="30" value="<?php echo $orderDetails[0]['PrescribedBefore'];?>" />
</td>
      </tr>
      <tr>
          <td>Prescribed Date</td>
        <td><input type="text"  disabled="disabled" class="required textbox" name="strPresDate" id="strPresDate" size="30" maxlength="30" value="<?php echo $orderDetails[0]['PrescribedDate'];?>" />
        </td>
      </tr>
      <tr>
          <td>Prescribed By </td>
          <td><input type="text"  class="required textbox" name="strPresBy" id="strPresBy" size="30" disabled="disabled"  maxlength="30"  value="<?php echo $orderDetails[0]['PrescribedBy'];?>"/>
          </td>
      </tr>
      <tr>
      	<td>Medical Condition </td>
		<td><input type="text"  class="required textbox" name="strMedCon" id="strMedCon" size="30" maxlength="30" disabled="disabled"  value="<?php echo $orderDetails[0]['MedicalConditions'];?>"/>
        </td>
      </tr>
      <tr>
      	<td>Allergies</td>
        <td>
        <input type="text"  class="required textbox" name="strAllergies" id="strAllergies" size="30" maxlength="30" disabled="disabled"  value="<?php echo $orderDetails[0]['Allergies'];?>"/>
        </td>
      </tr>
      <tr>
          <td>Physician</td>
          <td><input type="text"  class="required textbox" name="strPhysician" id="strPhysician" size="30" disabled="disabled"  maxlength="30" value="<?php echo $orderDetails[0]['Physician'];?>" /></td>
      </tr>
 </table>
  </td>
  ...
  <table>
          <tr>
          <td>Last Visit</td>
          <td><input type="text"  class="required textbox" name="strlstVist" id="strlstVist" disabled="disabled"  size="30" maxlength="30" value="<?php echo $orderDetails[0]['LastVisit'];?>" />
          </td>
          </tr>
		    <tr>
         	<td>Last Visit Reason</td>
			<td>
<input type="text"  class="required textbox" name="strlstVistreason" id="strlstVistreason" size="30" disabled="disabled"  maxlength="30" value="<?php echo $orderDetails[0]['LastVisitReason'];?>" />
            </td>
            </tr>
			<tr>
            <td>Primary Medical Care</td>
   			<td>
   <input type="text"  disabled="disabled" class="required textbox" name="strPMedCare" id="strPMedCare" size="30" maxlength="30" value="<?php echo $orderDetails[0]['PrimaryMedicalCare'];?>"/>
   			</td>
           	</tr>
    		<tr>
