...
JQ(document).ready(function() {
  ...
  <tr>
    ...
    <table>
  <tr>
    <td><h4 style="color:#39F"><b>Your Personal Details</b></h4> </td>
    </tr>
    <tr>
  ...
  <tr>
    ...
    <table>
    <tr>
    <td><h4 style="color:#39F"><b>Your Address</b></h4> </td>
    </tr>
    ...
    <td>Product</td>
    <td>
    <select name="strProduct" id="select" class="required">
	    <option value="">--Select--</option>
	    <?php  $ProdIDs = $sqli->get_selectData("SELECT * FROM  product");
			   foreach($ProdIDs as $ProdID){ ?>
	    <option value="<?php echo $ProdID['id']; ?>" <?php if($ProdID['product_id']==$_POST['strProduct']) echo "selected"; ?> >
    ...
    <td>Qwantity</td>
    <td>
    	    <select name="strQuantity" id="strQuantity">
...
<tr>
    <td colspan="2">
      <label>              
          <input name="payment_mode" value="Credit Card" id="payment_mode" checked="checked" type="radio">Credit Card
      </label>
       <label>
    <input id="payment_mode" type="radio" value="Cash On delivery" name="payment_mode"></input>Cash On Delievry
    </label>
    </td></tr>
    <tr>
